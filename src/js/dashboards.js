  ...
  async auth() {
    try {
      const response = await axios({
        url: `https://map-of-me-api.onrender.com/api/v1/users/adminView/${this.hash}`,
        method: 'GET',
...
export class Statistics extends DashboardView {
  ...
  async _getLevelData(level) {
    const response = await axios({
      method: 'GET',
      url: `https://map-of-me-api.onrender.com/api/v1/users/statistics/levels/${level}`,
      withCredentials: true,
    });
  ...
  async _getMetricData(metric) {
    const response = await axios({
      method: 'GET',
      url: `https://map-of-me-api.onrender.com/api/v1/users/statistics/metrics/${metric}`,
      withCredentials: true,
    });
  ...
  async _getAgeData(age) {
    const response = await axios({
      method: 'GET',
      url: `https://map-of-me-api.onrender.com/api/v1/users/statistics/ages/${age}`,
      withCredentials: true,
    });
...
>
  ...
  async _getAllUsers() {
    const response = await axios({
      url: `https://map-of-me-api.onrender.com/api/v1/users/usersFeedbacks`,
      method: 'GET',
      withCredentials: true,
    });
...
export class Stories extends DashboardView {
  ...
  async _getAllStories() {
    try {
      const response = await axios({
        url: `https://map-of-me-api.onrender.com/api/v1/users?fields=true`,
        method: 'GET',
        withCredentials: true,
      });
